...
PRIMARY_DEFAULT_CMD="$(tmux_get '@primary-default-cmd' 'xargs setsid -f $BROWSER')"
...
ALTERNATE_DEFAULT_CMD="$(tmux_get '@alternate-default-cmd' 'xclip -in -selection primary -f | xclip -in -selection clipboard &>/dev/null')"
